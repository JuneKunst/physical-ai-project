...
WINDOW_NAME = "Week 3 - Pixel to World"
MIN_AREA = 500
...
def setup_plot():
    ...
    figure.canvas.manager.set_window_title("Week 3 - Coordinate History")
    figure.tight_layout()
...
def main():
    ...
    parser.add_argument("--result-path", default="result_week3.png")
